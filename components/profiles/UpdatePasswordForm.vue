<template>
  <v-row class="mt-6">
    <v-col cols="12" md="4">
      <h2 class="mb-2 title font-weight-medium">Update Password</h2>

      <p class="ma-0 text--secondary">
        Ensure your account is using along, random password to stay secure.
      </p>
    </v-col>
          ...
          <v-card-text>
            ...
            >
              <v-text-field
                ...
                "
                :type="
                  formSettings.isShowConfirmationPassword ? 'text' : 'password'
                "
